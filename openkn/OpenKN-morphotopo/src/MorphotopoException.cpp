 ...
 * MorphotopoException.cpp created in 9 2009.
 ...
 * Internal Includes
 */
#include "MorphotopoException.hpp"
...
namespace kn{
	...
	MorphotopoException::MorphotopoException(const std::string& err, const std::string& funcname){
	  if(funcname=="" && err=="")
	...
	MorphotopoException::MorphotopoException(const MorphotopoException & e) : std::exception() {
	  str = e.errorString();	  
	}
