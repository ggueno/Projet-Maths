 ...
 * GeometryExceptionTest.hpp created in 09 2008.
 ...
 * Anti-doublon
 */
#ifndef __OPENKN_GEOMETRY__GEOMETRYEXCEPTIONTEST_HPP__
#define __OPENKN_GEOMETRY__GEOMETRYEXCEPTIONTEST_HPP__
 ...
 * Internal Includes
 */
#include <OpenKN/geometry/GeometryException.hpp>

/*
 * Class definition
 */

class GeometryExceptionTest : public CxxTest::TestSuite {
public:
	void testConstructorWithTwoParameters( void ) {
		kn::GeometryException e("World!","Hello,");
