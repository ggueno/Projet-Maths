 ...
 * GeometryException.hpp created in 3 2009.
 ...
 * Anti-doublon
 */
#ifndef __OPENKN_GEOMETRY__GEOMETRYEXCEPTION_HPP__
#define __OPENKN_GEOMETRY__GEOMETRYEXCEPTION_HPP__
...
namespace kn{
    ...
    /** \brief Exception thrown in case of geometry error
     *
     */
    class GeometryException : std::exception {
	...
	*/
    ...
    /** \brief Operator << for GeometryException
     *	\param stream output stream
     *	\err GeometryException to print
     *	\return output stream
     */
    inline std::ostream& operator <<(std::ostream& stream, const GeometryException & err){
