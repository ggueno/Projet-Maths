 ...
 * CudaException.hpp created in 7 2009.
 ...
 * Anti-doublon
 */
#ifndef __OPENKN_CUDA__CUDAEXCEPTION_HPP__
#define __OPENKN_CUDA__CUDAEXCEPTION_HPP__
...
namespace kn{	
	...
	/** \brief Exception thrown in case of cuda error
	 *
	 */
	...
	public:
		 ...
		 */
		CudaException(const std::string& err="", const std::string& funcname="");
	...
	/** \brief Operator << for CudaException
	 *	\param stream output stream
	 *	\err CudaException to print
	 *	\return output stream
	 */
	inline std::ostream& operator <<(std::ostream& stream, const CudaException & err){
