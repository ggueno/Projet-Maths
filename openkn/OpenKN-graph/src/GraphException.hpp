 ...
 * GraphException.hpp created in 6 2009.
 ...
 * Anti-doublon
 */
#ifndef __OPENKN_GRAPH__GRAPHEXCEPTION_HPP__
#define __OPENKN_GRAPH__GRAPHEXCEPTION_HPP__
...
namespace kn{	
	...
	/** \brief Exception thrown in case of graph error
	 *
	 */
	...
	public:
		 ...
		 */
		GraphException(const std::string& err="", const std::string& funcname="");
		/** \brief Copy Constructor
		 *	\param e Error to clone
		 */
		GraphException(const GraphException & e);
	...
	/** \brief Operator << for GraphException
	 *	\param stream output stream
	 *	\err GraphException to print
	 *	\return output stream
	 */
	inline std::ostream& operator <<(std::ostream& stream, const GraphException & err){
