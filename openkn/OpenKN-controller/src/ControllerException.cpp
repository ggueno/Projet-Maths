 ...
 * ControllerException.cpp created in 10 2008.
...
namespace kn{
	...
	ControllerException::ControllerException(const std::string& err, const std::string& funcname){
		if(funcname=="" && err=="")
	...
	ControllerException::ControllerException(const ControllerException & e) : std::exception(){
		str = e.errorString();		
	}
