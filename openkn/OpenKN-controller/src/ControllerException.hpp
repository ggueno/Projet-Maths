 ...
 * ControllerException.hpp created in 10 2008.
 ...
 * Anti-doublon
 */
#ifndef __OPENKN_CONTROLLER__CONTROLLEREXCEPTION_HPP__
#define __OPENKN_CONTROLLER__CONTROLLEREXCEPTION_HPP__
...
namespace kn{
	...
	/** \brief Operator << for ControllerException
	 *	\param stream output stream
	 *	\param err ControllerException to print
	 *	\return output stream
	 */
	inline std::ostream& operator <<(std::ostream& stream, const ControllerException & err){
